...
export default function ContactModal({
  ...
  const getDisplayName = () => {
    ...
    // Otherwise use hs_full_name_or_email if available
    if (hs_full_name_or_email) return hs_full_name_or_email;
  ...
  const updateMutation = useMutation({
    mutationFn: (data: Partial<Contact["properties"]>) =>
  ...
  const inputClasses =
    "pl-10 block w-full rounded-xl bg-white border border-gray-200 text-gray-900 shadow-sm focus:border-primary focus:ring-primary hover:border-gray-300 transition-all duration-200 ease-in-out sm:text-sm h-10";
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6">
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-left sm:ml-4 sm:mt-0 w-full">
                    ...
                    >
                      {isEditing ? "Edit Contact" : getDisplayName()}
                    </Dialog.Title>
                            ...
                            <div className="mt-2">
                              <div className="relative">
                                ...
                                >
                                  ...
                                  <option value="marketingqualifiedlead">
                                    Marketing Qualified Lead
                                  </option>
                                  <option value="salesqualifiedlead">
                                  ...
                                  <span
                                    className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ${
                                      LifecycleStageColors[
                                        lifecyclestage?.toLowerCase() || "other"
                                      ]?.bg || "bg-gray-50"
                                    } ${
                                      LifecycleStageColors[
                                        lifecyclestage?.toLowerCase() || "other"
